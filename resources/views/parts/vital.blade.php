<section>
    ...
    <div style="margin-bottom: 15px;">
        <select id="vital-client-select" style="width: 100%; padding: 8px; border-radius: 4px; border: 1px solid #ddd; background-color: #f8f9fa; font-weight: bold; font-size: 1em;">
